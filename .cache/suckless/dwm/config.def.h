...
static const char *fonts[]    = { "Cantarell:style=Regular:size=10:antialias=true:autohint=true", "FontAwesome:style=Regular:size=10:antialias=true:autohint=true", "Font awesome 6 Free Solid:style=Solid:size=10:antialias=true:autohint=true" };
static char dmenufont[]       = "Cantarell:style=Regular:size=10:antialias=true:autohint=true";
...
/*	{ 0, XF86XK_AudioMute,                          spawn,                SHCMD("pactl set-sink-mute 0 toggle") },
	...
	{ MODKEY|Mod1Mask,              XK_t,           spawn,                SHCMD("mpc toggle") },
